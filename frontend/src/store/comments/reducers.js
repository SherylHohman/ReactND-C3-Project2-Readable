...
const { GET_COMMENTS } = actionTypes;
const { REQUEST_COMMENTS,         FETCH_COMMENTS_SUCCESS,  FETCH_COMMENTS_FAILURE } = actionTypes;
const { REQUEST_ADD_COMMENT,         ADD_COMMENT_SUCCESS,     ADD_COMMENT_FAILURE } = actionTypes;
const { REQUEST_EDIT_COMMENT,       EDIT_COMMENT_SUCCESS,    EDIT_COMMENT_FAILURE } = actionTypes;
const { REQUEST_DELETE_COMMENT,   DELETE_COMMENT_SUCCESS,  DELETE_COMMENT_FAILURE } = actionTypes;
const { REQUEST_VOTE_ON_COMMENT, VOTE_ON_COMMENT_SUCCESS, VOTE_ON_COMMENT_FAILURE } = actionTypes;


// SAMPLE DATA

  // store element is sampleComments
  //    aka an object of comment objects, where the key
  //    for each (comment object) is the id for that comment.
  ...
  const fetchedCommentsInitialState = {};
