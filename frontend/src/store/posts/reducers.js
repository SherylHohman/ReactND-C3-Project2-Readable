...
// ACTION TYPES
import * as postsActionTypes from './constants';
import { ADD_COMMENT_SUCCESS, DELETE_COMMENT_SUCCESS } from '../comments/constants';

const { REQUEST_POSTS,         FETCH_POSTS_SUCCESS,  FETCH_POSTS_FAILURE } = postsActionTypes;
const { REQUEST_POST,           FETCH_POST_SUCCESS,   FETCH_POST_FAILURE } = postsActionTypes;
const { REQUEST_ADD_POST,         ADD_POST_SUCCESS,     ADD_POST_FAILURE } = postsActionTypes;
const { REQUEST_EDIT_POST,       EDIT_POST_SUCCESS,    EDIT_POST_FAILURE } = postsActionTypes;
const { REQUEST_DELETE_POST,   DELETE_POST_SUCCESS,  DELETE_POST_FAILURE } = postsActionTypes;
const { REQUEST_VOTE_ON_POST, VOTE_ON_POST_SUCCESS, VOTE_ON_POST_FAILURE } = postsActionTypes;
